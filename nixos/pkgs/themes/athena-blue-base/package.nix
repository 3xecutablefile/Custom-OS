...
stdenvNoCC.mkDerivation (finalAttrs: {
  pname = "nebula-blue-base";
  version = "0-unstable-2025-06-21";

  src = fetchFromGitHub {
    owner = "nebula-OS";
    repo = "nebula-blue-base";
  ...
  installPhase = ''
    ...
    cp -r wallpapers/arch-ascii.png $out/share/backgrounds/nebula/
    cp -r wallpapers/nix-behind.png $out/share/backgrounds/nebula/
  ...
  meta = with lib; {
    ...
    homepage = "https://github.com/nebula-OS/nebula-blue-base";
