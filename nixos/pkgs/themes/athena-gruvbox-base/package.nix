...
stdenvNoCC.mkDerivation (finalAttrs: {
  pname = "nebula-gruvbox-base";
  version = "0-unstable-2025-06-21";

  src = fetchFromGitHub {
    owner = "nebula-OS";
    repo = "nebula-gruvbox-base";
  ...
  installPhase = ''
    ...
    cp -r wallpapers/cyborg-gruv.png $out/share/backgrounds/nebula/
  ...
  meta = with lib; {
    ...
    homepage = "https://github.com/nebula-OS/nebula-gruvbox-base";
