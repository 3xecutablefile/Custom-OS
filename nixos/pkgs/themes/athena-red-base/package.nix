...
stdenvNoCC.mkDerivation (finalAttrs: {
  pname = "nebula-red-base";
  version = "0-unstable-2025-06-21";

  src = fetchFromGitHub {
    owner = "nebula-OS";
    repo = "nebula-red-base";
  ...
  installPhase = ''
    ...
    cp -r wallpapers/akame.jpg $out/share/backgrounds/nebula/
    cp -r wallpapers/murasame.jpg $out/share/backgrounds/nebula/
    cp -r wallpapers/redmoon.png $out/share/backgrounds/nebula/
  ...
  meta = with lib; {
    ...
    homepage = "https://github.com/nebula-OS/nebula-red-base";
