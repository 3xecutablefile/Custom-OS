...
in {
  config = lib.mkIf (config.nebula.desktopManager == "cinnamon") {
    ...
    home-manager.users.${config.nebula.homeManagerUser} = { pkgs, ...}: {
      dconf.settings = {
        "org/cinnamon/desktop/background" = {
          picture-uri = "file:///run/current-system/sw/share/backgrounds/nebula/${backgroundTheme}";
          picture-uri-dark = "file:///run/current-system/sw/share/backgrounds/nebula/${backgroundTheme}";
        };
