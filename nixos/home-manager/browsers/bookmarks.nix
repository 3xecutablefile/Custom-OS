[
		...
		bookmarks = [
	{
		...
		bookmarks = [
			{
				name = "nebula OS Website";
				url = "https://nebulaos.org";
			}
			{
				name = "Docker Hub Images";
				url = "https://hub.docker.com/u/nebulaos";
			}
			{
				name = "Nix Configuration";
				url = "https://github.com/nebula-OS/nebula-nix";
			}
			{
				name = "Project Source";
				url = "https://github.com/nebula-OS";
			}
			{
